...
class Handler
{
  ...
  private:
     ...
     * @return void
     */
    void handlePowerEvent(PowerEvent powerEventType, const std::string& objectPath,
    ...
    /**
     * @brief Flag to indicate multi power button mode(false) or host select button mode(true)
     */
