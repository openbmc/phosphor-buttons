...
class Handler
{
  ...
  private:
    ...
    /**
     * @brief The handler for a longer power button press
     *
     * @param[in] msg - sdbusplus message from signal
     */
    void longerPowerPressed(sdbusplus::message_t& msg);
     ...
     */
    std::vector<std::shared_ptr<sdbusplus::bus::match_t>> multiPowerButtonReleased;

    /**
     * @brief Matches on the multi power button long press released signal
     */
    std::vector<std::shared_ptr<sdbusplus::bus::match_t>> multiPowerButtonLongPressed;

        /**
     * @brief Matches on the multi power button long press released signal
     */
    std::vector<std::shared_ptr<sdbusplus::bus::match_t>> multiPowerButtonLongerPressed;
